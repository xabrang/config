		...
		config = function()
			require("modus-themes").setup({
				...
				on_highlights = function(highlights, colors)
					highlights.CursorLine = { bg = colors.bg_status_line_active }
					highlights.CursorLineNr = { bg = colors.bg_status_line_active }
					highlights.LineNr = { bg = colors.bg_status_line_active }
					highlights.ColorColumn = { bg = colors.bg_status_line_active }
					highlights.SignColumn = { bg = colors.bg_status_line_active }
				end,
			})
